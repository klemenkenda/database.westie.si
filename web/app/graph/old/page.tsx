/**
 * The old graph studio — the imported concept graph, kept editable while it is replaced.
 *
 * The graph is being rebuilt from scratch in the builder at /graph/, with this one as its
 * reference. This page stays so the old graph can still be read, audited and corrected,
 * but it is no longer where the graph is built.
 *
...
export const metadata = { title: "Old graph studio — database.westie.si" };
